    ...
    def integrar(cls, f, limite_inferior_a, limite_superior_b, c, grau, exponencial_simples=True, tol=1e-6):
        ...
        while converge:
            ...
            for particao in range(particoes):
                ...
                x_final = x_inicial+tamanho_particao
                if grau == 1:
                    soma = soma + cls.__grau_1(f, x_inicial, x_final, limite_inferior_a, limite_superior_b, exponencial_simples)
                elif grau == 2:
                    soma = soma + cls.__grau_2(f, x_inicial, x_final, limite_inferior_a, limite_superior_b, exponencial_simples)
                elif grau == 3:
                    soma = soma + cls.__grau_3(f, x_inicial, x_final, limite_inferior_a, limite_superior_b, exponencial_simples)
                elif grau == 4:
                    soma = soma + cls.__grau_4(f, x_inicial, x_final, limite_inferior_a, limite_superior_b, exponencial_simples)
                else:
                    print("Grau inválido.")
                    return
